...
const file_grpc_proto_proto_rawDesc = "" +
	...
	"\n" +
	"logic_time\x18\x03 \x01(\x03R\tlogicTime\"\x1a\n" +
	"\x04User\x12\x12\n" +
	...
	"\x05Leave\x12\x0e.chitchat.User\x1a\r.chitchat.AckB\x10Z\x0echit-chat/grpcb\x06proto3"
...
var file_grpc_proto_proto_depIdxs = []int32{
	...
	2, // 3: chitchat.ChatService.SendMessage:output_type -> chitchat.Ack
	0, // 4: chitchat.ChatService.ReceiveMessages:output_type -> chitchat.Message
	2, // 5: chitchat.ChatService.Leave:output_type -> chitchat.Ack
